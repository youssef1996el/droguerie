         ...
         <nav class="sidebar-nav scroll-sidebar" data-simplebar>
           <ul class="sidebar-menu" id="sidebarnav">
            ...
            <li class="sortable-group" data-id="group7">
                ...
                @can('Devis')
                    <div class="sidebar-item">
                        <a class="sidebar-link {{Request::is('Devis') ? 'active' : ''}} " href="{{url('Devis')}}" aria-expanded="false">
            ...
            @can('recouverement')
                <li class="sortable-group" data-id="group11">
                    ...
                    <div class="sidebar-item">
                        <a class="sidebar-link {{Request::is('Suivirecouverement') ? 'active' : ''}}" href="{{url('Suivirecouverement')}}">

                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-eye-dollar">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            ...
                            <span class="hide-menu">Suivi recouverement</span>
                        </a>
                    </div>
                    <div class="sidebar-item">
                      <a class="sidebar-link {{Request::is('ListPaiement') ? 'active' : ''}}" href="{{url('ListPaiement')}}">

                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-zoom-money">
                          <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                          ...
                          <span class="hide-menu">List de paiement</span>
                      </a>
                  </div>
                    <div class="sidebar-item">
                      <a class="sidebar-link {{Request::is('Listcredit')}}" href="{{url('Listcredit')}}">
                        ...
                        <span class="hide-menu">List Crédit</span>
                      </a>
                    </div>
                    <div class="sidebar-divider lg"></div>
                </li>
            ...
            @can('Renenus')
              <li class="sortable-group" data-id="group12">
                <div class="nav-small-cap">
                    <iconify-icon icon="solar:menu-dots-linear" class="mini-icon"></iconify-icon>
                    <span class="hide-menu">Gestion de revenus </span>
                </div>
                <div class="sidebar-item">
                    <a href="{{url('revenus')}}" class="sidebar-link {{Request::is('SoldeCaisse') ? 'active' : ''}}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-currency-dollar">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            <path d="M16.7 8a3 3 0 0 0 -2.7 -2h-4a3 3 0 0 0 0 6h4a3 3 0 0 1 0 6h-4a3 3 0 0 1 -2.7 -2" />
                            <path d="M12 3v3m0 12v3" />
                        </svg>
                        <span class="hide-menu">Obtenir des revenus </span>
                    </a>
                </div>
            </li>
          @endcan
