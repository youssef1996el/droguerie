...
<head>
    ...
    <!-- Fontawesome CSS -->
    <link rel="stylesheet" href="{{asset('css/login/fontawesome-all.min.css')}} ">
    <!-- Flaticon CSS -->
    <link rel="stylesheet" href="{{asset('css/login/flaticon.css')}}">
    <!-- Google Web Fonts -->
...
<body>
    ...
    <section class="fxt-template-animation fxt-template-layout34" data-bg-image="{{asset('images_login/bg1.png')}}">
        <div class="fxt-shape">
            <div class="fxt-transformX-L-50 fxt-transition-delay-1">
                <img src="{{asset('images_login/shape1.png')}}" alt="Shape">
            </div>
        </div>
        <div class="container">
            <div class="row">
    ...
    <script src="{{asset('js/script_login/jquery.min.js')}}"></script>
    <!-- Bootstrap js -->

    <script src="{{asset('js/script_login/bootstrap.min.js')}}"></script>
    <!-- Imagesloaded js -->
    <script src="{{asset('js/script_login/imagesloaded.pkgd.min.js')}}"></script>
    <!-- Validator js -->
    <script src="{{asset('js/script_login/validator.min.js')}}"></script>
    <!-- Custom Js -->
    <script src="{{asset('js/script_login/main.js')}}"></script>
