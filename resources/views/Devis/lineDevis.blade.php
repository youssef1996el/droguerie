...
<div class="container-fluid">
    ...
    <div class="widget-content searchable-container list">
        <div class="card card-body">
            <h5 class="card-title border p-2 bg-light rounded-2 mb-4">Information client par devis N° {{$id}}</h5>
            <div class="row">
    ...
    <div class="card card-body">
        <h5 class="card-title border p-2 bg-light rounded-2">Fiche détail devis</h5>
        <div class="table-responsive">
            <table class="table table-bordered table-striped TableLineDevis">
                <thead>
                    <tr>
                        <th>Produit</th>
            ...
            <div class="d-flex">
                ...
                <div class="flex-fill">
                    <table class="table table-striped table-bordered">
                        ...
                        @if ($CheckFacutreOrBon->type == 'Facture')
                            @php
